...
# Transformer Dataset (seq_length = 72)
...
# GRU, TCNN, PPO Dataset (seq_length = 36)
...
lstm_model = LSTMModel(len(features), 128, 1, 3, 0.3).to('cuda')  # Correct Config
...
# ============================
# TCNN Model Training and Evaluation
# ============================
print("\n============================")
...
# ============================
# PPO (Deep RL) Model Training and Evaluation
# ============================
print("\n============================")
